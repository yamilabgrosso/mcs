<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Triunfo.aspx.cs" Inherits="LasSuperadoras.Triunfo" %>
    ...
    <head>
        ...
        <title>Mejor con Seguros | Triunfo</title>
        ...
        <main class="mainIndex">
            ...
            <section class="marcaSeguro">
                <div class="ofrecimientoXMarca-page" id="irSeguros">
                    <img src="images/triunfo-principal.png" alt="Triunfo" class="logoPrincipal">
                    <h1>Protegé<br> tu bienestar</h1>
                    <p>Mantener una buena salud financiera es muy importante.
                        Contar con nuestro Seguro te garantiza mantener la calidad de vida de tu entorno en caso de
                        tener un accidente.
                    </p>
                    <h2>Accidentes personales</h2>
                    <p class="info" data-bs-toggle="modal" data-bs-target="#bienestarModal">+info</p>
                    <hr class="b-gradiente">
                    <p class="precio">Precio promocional: <b class="number">$600</b> mensuales.</p>
                    <hr class="b-gradiente">
                </div>
            </section>
            ...
            <section class="inicial inicialMarcas">
                ...
                <div class="chicaConCapa">
                    <img src="images/chica-triunfo.png" alt="Chica con capa">
                </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sancor.aspx.cs" Inherits="LasSuperadoras.Sancor" %>
    ...
    <head>
        ...
        <title>Mejor con Seguros | Sancor</title>
        ...
        <main class="mainIndex">
            ...
            <section class="marcaSeguro">
                <div class="ofrecimientoXMarca-page" id="irSeguros">
                    <img src="images/sancor-principal.png" alt="Sancor" class="logoPrincipal">
                    <h1>Protegé<br> tu propia vida</h1>
                    <p>Elegir cuidarte es tener una actitud previsora que ayude a protegerte a vos y a dar un respaldo a
                        los que te acompañan.
                        Nuestro Seguro de Salud brinda cobertura indemnizatoria que cubre las enfermedades oncológicas
                        más habituales en las mujeres.
                    </p>
                    <h2>Salud Segura Mujer</h2>
                    <p class="info" data-bs-toggle="modal" data-bs-target="#tuvidaModal">+info</p>
                    <hr class="b-gradiente">
                    <p class="precio">Precio promocional: <b class="number">$330</b> mensuales.</p>
                    <hr class="b-gradiente">
                </div>
            </section>
            ...
            <section class="inicial inicialMarcas">
                ...
                <div class="chicaConCapa">
                    <img src="images/chica-sancor.png" alt="Chica con capa">
                </div>
